...
auth_email="Zamfiracheandrei96@gmail.com"                                       # The email used to login 'https://dash.cloudflare.com'
auth_method="token"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="fUcCGggBeztxqlzdhNRrjkGxydKM9xK60_WMUgTc"                                         # Your API Token or Global API Key
zone_identifier="b70dcb0199bd71c99351d8444dafb174"                                  # Can be found in the "Overview" tab of your domain
record_name="butonulrosu.cc"                                      # Which record you want to be synced
